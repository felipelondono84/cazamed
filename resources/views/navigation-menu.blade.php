        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="font-bold text-gray-700 dark:text-gray-500">Iniciar Sesion</a>
                        <a href="{{ route('register') }}" class="font-bold ml-4 text-gray-700 dark:text-gray-500">Registrarse</a>
                    @endauth
                </div>
            </div>
