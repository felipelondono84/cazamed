<x-app-layout>
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                @if ($course->image)
                    <img class="h-30 w-full object-cover" src="{{ asset('img/home/controlar-de-la-diabetes-10675775.jpg')}}" alt="">
                @else
                    <img class="h-30 w-full object-cover" src="{{ asset('img/home/peque.jpg') }}" alt="">
           ...
           <section class="card mb-4">
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h1 class="font-fold text-gray-500 text-lg">Dr.{{ $course->teacher->name }}</h1>
                   ...
                   <form action="{{ route('admin.courses.approved', $course) }}" class="mt-4"  method="post">
                        ...
                        <button class="btn btn-primary w-full">Aprobar curso</button>
                   </form>

                   <a href="{{ route('admin.courses.observation', $course) }}" class="btn btn-danger w-full block text-center mt-4">Registrar observación</a>
