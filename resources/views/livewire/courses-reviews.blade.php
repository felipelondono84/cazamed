    ...
    @can('enrolled', $course)
        <article class="mb-4">
            @can('valued', $course)
                ...
                <textarea wire:model="comment" class="form-input w-full" rows="3" placeholder="Ingrese un comentario del curso"></textarea>
                ...
                <article class="flex mb-4 text-gray-800">
                   ...
                   <div class="card flex-1">
                        <div class="card-body bg-gray-100">
                            <p><b>{{ $review->user->name }}</b><i class="fa fa-star text-yellow-400"></i>({{ $review->rating }})</p>
