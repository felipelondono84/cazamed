<div class="mt-8">
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="card_body">
                ...
                <div class="relative pt-1">
                    <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200">
                      <div style="width:{{ $this->advance .'%' }}" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500 bg-blue-500 transition-all duration-500"></div>
                    </div>
                </div> --}}
                                    ...
                                    <div>
                                        @if ($lesson->completed)
                                            ...
                                            @if ($current->id == $lesson->id)
                                                <p class="inline-block w-4 h-4 border-solid border-yellow-300 rounded-full mr-2 mt-1"></p>
                                            @else
        ...
        <div class="lg:col-span-2">
            ...
            <div class="card mt-2 text-gray-500 font-bold">
