<x-app-layout>
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                <img class="h-30 object-cover" src="{{ asset('img/home/controlar-de-la-diabetes-10675775.jpg')}}" alt="">
            </figure>  
           ...
           <section class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h1 class="font-bold text-gray-500 text-lg">Dr.{{ $course->teacher->name }}</h1>
           ...
           <aside class="hidden lg:block">
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <img class="h-32 w-40 object-cover" src="{{ asset('img/home/slider.jpg')}}" alt=""> 
                        <div class="ml-3">
                            <h1>
