    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="card text-gray-600">
            <div class="card-body">
                ...
                <hr>
                <p class="text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique a facilis voluptate assumenda neque sunt porro atque beatae asperiores, tenetur inventore laborum cum velit ullam, hic iure non quod dolor!  <a class="text-red-500 font-bold" href="">Terminos y condiciones</a></p>
            </div>
        </div>
    </div>
</x-app-layout>